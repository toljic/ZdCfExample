package de.zerodefects.repository;

import de.zerodefects.ZdCfExampleApp;
import de.zerodefects.config.Constants;
import de.zerodefects.config.audit.AuditEventConverter;
import de.zerodefects.domain.PersistentAuditEvent;
...
import static de.zerodefects.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
